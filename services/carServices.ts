...
class CarServices implements ICarServices {
    ...
    static serviceName = "services.carServices";
...
angular.module("wmApp").factory(CarServices.serviceName, ["$resource", ($resource: ng.resource.IResourceService) => new CarServices($resource)]);
